...
public class APITestUtil {
     ...
     *
     * @param processInstanceId the id of a running instance.
     * @throws Exception
     */
     ...
     *
     * @param processInstanceId the id of a running instance.
     * @param flowNodeName      the name of the task as defined in process definition.
     * @param state             the state of the task to wait for.
     * @return the task.
     * @throws Exception
     */
