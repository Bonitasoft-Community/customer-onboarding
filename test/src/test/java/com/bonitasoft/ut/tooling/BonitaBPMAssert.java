...
public class BonitaBPMAssert {
     ...
     *
     * @param processInstanceId id of the running process instance.
     * @param string            name of the task as defined in Bonita BPM Studio.
     * @param taskInputs        inputs that match contract definition.
     * @param userId            id of a user existing in the test environment. You can use {@link APISession#getUserId()} to set this
     *                          value.
     * @throws Exception
     */
     ...
     *
     * @param businessObjectClass business object class. E.g. VacationRequest.class.
     * @param processInstanceId   id of the running process instance. If process instance is archived it will be used to search latest
     *                            archived process instance informations.
     * @param businessDataName    the name of the business data as declared in the process definition in the Studio.
